...
class DomeAdParam {
    ...
    if (!isset(self::$_TSPEC)) {
      self::$_TSPEC = array(
        1 => array(
          'var' => 'token',
          'type' => TType::STRUCT,
          'class' => '\DomeShared\DomeTokenParam',
          ),
        2 => array(
          'var' => 'page',
          'type' => TType::STRUCT,
          'class' => '\DomeShared\DomePageParam',
          ),
        );
    }
    if (is_array($vals)) {
      ...
      switch ($fid)
      {
        case 1:
          if ($ftype == TType::STRUCT) {
            $this->token = new \DomeShared\DomeTokenParam();
        ...
        case 2:
          if ($ftype == TType::STRUCT) {
            $this->page = new \DomeShared\DomePageParam();
  ...
  public function write($output) {
    $xfer = 0;
    $xfer += $output->writeStructBegin('DomeAdParam');
    if ($this->token !== null) {
...
class DomeAdItem {
  ...
  public function write($output) {
    $xfer = 0;
    $xfer += $output->writeStructBegin('DomeAdItem');
    if ($this->title !== null) {
...
class DomeResultAd {
    ...
    if (!isset(self::$_TSPEC)) {
      self::$_TSPEC = array(
        ...
        2 => array(
          ...
          'elem' => array(
            'type' => TType::STRUCT,
            'class' => '\DomeInformation\DomeAdItem',
            ),
          ),
        3 => array(
          'var' => 'Message',
        ...
        4 => array(
          'var' => 'Page',
          'type' => TType::STRUCT,
          'class' => '\DomeShared\DomeResultPage',
          ),
        );
    }
    if (is_array($vals)) {
      ...
      switch ($fid)
      {
        ...
        case 2:
          if ($ftype == TType::LST) {
            ...
            {
              $elem5 = null;
              $elem5 = new \DomeInformation\DomeAdItem();
        ...
        case 4:
          if ($ftype == TType::STRUCT) {
            $this->Page = new \DomeShared\DomeResultPage();
            $xfer += $this->Page->read($input);
          } else {
            $xfer += $input->skip($ftype);
          }
  ...
  public function write($output) {
    $xfer = 0;
    $xfer += $output->writeStructBegin('DomeResultAd');
    if ($this->Status !== null) {
